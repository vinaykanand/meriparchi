                          ...
                          return (
                            <React.Fragment key={i}>
                              ...
                              >
                                ...
                                <td className={`px-2 py-0.5 font-medium text-right text-xs ${parseFloat(s.amt) < 0 ? 'text-red-500' : 'text-slate-900 dark:text-slate-100'}`}>₹{s.amt}</td>
                              </tr>
                              {isLast && (
