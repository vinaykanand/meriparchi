        ...
        <div className="lg:col-span-2 flex flex-col gap-6">
          <div className="bg-white/80 dark:bg-slate-800/70 border border-slate-200 dark:border-slate-700 rounded-2xl p-6 shadow-sm backdrop-blur-xl">
            <div className="flex justify-between items-center mb-4">
              ...
              <button
                disabled
                className="flex items-center gap-1.5 px-3.5 py-1.5 rounded-xl bg-blue-600/20 text-blue-600 dark:text-blue-400 border border-blue-200 dark:border-blue-800/30 hover:bg-blue-650/30 text-xs font-bold transition-all opacity-50 cursor-not-allowed"
              >
                ...
                <tbody className="divide-y divide-slate-200 dark:divide-slate-800 text-sm">
                  {coupons.map((coupon) => (
                    <tr key={coupon.code} className="hover:bg-slate-50/30 dark:hover:bg-slate-700/10 transition-colors">
                      <td className="py-3 px-4 font-mono font-bold text-blue-600 dark:text-blue-400 uppercase tracking-wide">
                        {coupon.code}
                      </td>
                      ...
                      <td className="py-3 px-4">
                        <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[10px] font-bold uppercase bg-emerald-50 text-emerald-700 dark:bg-emerald-950/40 dark:text-emerald-400 border border-emerald-250 dark:border-emerald-800/30">
